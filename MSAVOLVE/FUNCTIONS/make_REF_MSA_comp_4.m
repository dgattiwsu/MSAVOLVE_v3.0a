function [ MSA_Clusters ] = ...
    make_REF_MSA_comp_4(REF_nmsa,MSA_select,DISTANCE,DIMENSIONS,...
    MAX_CLUSTERS,REF_rel_entropy,MSA_rel_entropy,b_ind2,...
    covar_vec)
