function [ rH_ai,rH_i,D_ai,D_i,Pm_ai ] = kldiv_nmsa( nmsa,bg_prob,seq_profile )
...
% probability q(a).
[nseq,npos] = size(nmsa);
rel_entropy_1 = zeros(20,npos);
rel_entropy_2 = zeros(20,npos);
rel_entropy_3 = zeros(20,npos);
Pm_ai = zeros(20,npos);
D_ai = zeros(20,npos);
rH_ai = zeros(20,npos);
