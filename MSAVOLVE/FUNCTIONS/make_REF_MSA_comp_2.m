function [ MSA_Clusters ] = ...
    make_REF_MSA_comp_2(REF_nmsa,REF_cov_mat,MSA_cov_mat,DIMENSIONS,MAX_CLUSTERS,...
    REF_rel_entropy,MSA_rel_entropy,covar_vec)

% This functions plots various comparisons between the Reference and
% Evolved MSAs.

% First we carry out a spectral analysis of the covariance matrix for both 
% the REF and evolved MSA.
...
figure(REF_MSA_seq_sim); 
subplot(2,4,6); 
o_MSA_cov_mat = sort_cov_mat_2(MSA_cov_mat);
