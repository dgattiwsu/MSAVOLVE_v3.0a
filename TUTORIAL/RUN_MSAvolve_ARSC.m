...
savefilename = 'ARSC_MSAvolve_run';
%--------------------------------------------------------------------------
...
DISTANCE = 0;   % Default is 0. Phylogenetic trees and clustering are based
...
ICA = 0; % default is 0. If fastICA is installed, setting ICA to 1 will 
         ...
         % sequences.
MAX_CLUSTERS = 8; % There is no default, it should be decided by looking at 
...
neighjoin_method = 'equivar'; % Neighbor-joining method: default is the
                ...
                % 4(4), 406–425, 1987).
criterion = 'maximum'; % Criterion used for clustering the branches of  
...
nzones = 7;       % This is the number of blocks in which the sequence is
...
crossover_points = [12 34 64 93 107 127]; % at .9999
% crossover_points = [];
%--------------------------------------------------------------------------
