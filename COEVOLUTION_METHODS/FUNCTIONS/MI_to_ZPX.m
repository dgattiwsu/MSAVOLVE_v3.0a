function [ ZPX_mat,ZPX2_mat ] = MI_to_ZPX( input_mat )
% This function calculates a Zpx and a squared Zpx matrix from an input MIP 
% matrix according to the algorith of Gloor et al. (2010). The squared Zpx
% matrix is identical to the ZRes matrix calculated with the algorithm of 
% Little and Chen, and implemented in the function MI_to_ZRES.
