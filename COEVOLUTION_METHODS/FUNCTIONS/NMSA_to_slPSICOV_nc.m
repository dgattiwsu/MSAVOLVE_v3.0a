function [pcZPX2,lgZPX2,sparsity_value,pcMIP,lgMIP,cov_inv,rho,COV,sCOV,lambda] = ...
    NMSA_to_slPSICOV_nc(nmsa,dist_method,threshold,psc_lambda,nsymbols,...
...
n_rho = NaN(ncols,ncols);
n_cov_inv = NaN(ncols,ncols);
n_rho(noncons_ind,noncons_ind) = n_rho_s;
n_cov_inv(noncons_ind,noncons_ind) = n_cov_inv_s;    
