function [ZPX2,md3_ZPX2,md4_ZPX2,lgZPX2,md3_lgZPX2,md4_lgZPX2,...
    ...
    NMSA_to_mdMI_6(nmsa,dist_method,md_method,memory_method,threshold,...
    psc_lambda,null_symbol,gW_e1,gW_e2,gW_e3,nprocs)
% Version 6: this version uses a transparent calculation of the average
% along the 3rd and 4th dimensions using for loops. However, this
% calculation is significantly slower than the vectorized algorithm used in
% the standard version of NMSA_to_mdMI.
...
% significantly slower with 'DEEP_SAVE'. Three rounds of gap weighting are
...
%       NMSA_to_mdMI(nmsa,'GAPS','3D','FULL',0.9,1,21,0,0,3,12);
%
...
% [ZPX2,md3_ZPX2,md4_ZPX2] = ...
%       NMSA_to_mdMI(nmsa,'GAPS','4D','FULL',0.9,1,22,0,1,3,12);
%
%--------------------------------------------------------------------------
