function [w, theta, iter, avgTol, hasError] = ...
    GraphicalLasso(pop, lambda, initStruct, approximate, ...
    warmInit, verbose, penalDiag, tolThreshold, maxIter, w, theta)
...
[w, theta, iter, avgTol, hasError] = glasso(numVars, cov(pop), 0, ...
    lambda, approximate, warmInit, verbose, penalDiag, ...
    tolThreshold, maxIter, w, theta);
