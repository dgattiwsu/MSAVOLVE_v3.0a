...
[ATP11_98_smsa,ATP11_98_nmsa] = faln_to_nmsa('ATP11_98.faln');

% [ATP11_98_smsa,ATP11_98_nmsa] = aln_to_nmsa('ATP11_98.aln');
...
REF_length = numel(ATP11_98_nmsa(1,1:205));
...
nmsa = ATP11_98_nmsa(:,1:REF_length);
smsa = int2aa(nmsa);
ncols = size(nmsa,2);
pdbfile = '2P4F_mod.pdb';

%%
% Here we calculate all the coevolution matrices.
...
[PSICOV,PSICOV_covar_vec] = get_nmsa_covar_vec(nmsa,30,'PSICOV');
...
% in the sorting.
 ...
 PSICOV_orig_2 = PSICOV_orig_1 - min(PSICOV_orig_1(:));
...
[c_distances,sorted_c_distances,sorted_ZPX2_1,...
    sorted_dbZPX2_1,sorted_PSICOV_1,sorted_DCA_1,pdbstruct_1] = ...
    coev_distance_matrix_3(pdbfile,1,first_res,last_res,ZPX2,dbZPX2,...
    PSICOV,DCA,radius,near,ncov,0);

%---------------------2nd set----------------------------------------------

[~,~,sorted_MIP_1,sorted_nbZPX2_1,sorted_gbZPX2_1,sorted_dgbZPX2_1] = ...
    coev_distance_matrix_3(pdbfile,1,first_res,last_res,MIP,nbZPX2,...
    gbZPX2,dgbZPX2,radius,near,ncov,0);

%---------------------3rd set----------------------------------------------

[~,~,sorted_MI_1,sorted_logR_1,sorted_ZRES_1,sorted_SCA_1] = ...
    coev_distance_matrix_3(pdbfile,1,first_res,last_res,MI,logR,...
    ZRES,SCA,radius,near,ncov,0);

%---------------------4th set----------------------------------------------

[~,~,sorted_OMES_1,sorted_McBASC_1,sorted_ELSC_1,sorted_fodorSCA_1] = ...
    coev_distance_matrix_3(pdbfile,1,first_res,last_res,OMES,McBASC,...
...
[~,~,sorted_ZPX2_2,sorted_dbZPX2_2,sorted_PSICOV_2,...
...
X = (1:ncov);
semilogy(X,sorted_MI_1(X,6),'-r','LineWidth',2);
semilogy(X,sorted_logR_1(X,6),'-','Color',[0.3,0.6,0.2],'LineWidth',2);
% semilogy(X,MIP_1(X,6),'-','Color',[0.3,0.6,0.2],'LineWidth',2);
semilogy(X,sorted_ZPX2_1(X,6),'-m','LineWidth',2);
semilogy(X,sorted_DCA_1(X,6),'-g','LineWidth',2);
semilogy(X,sorted_nbZPX2_1(X,6),'-c','LineWidth',2);
semilogy(X,sorted_dbZPX2_1(X,6),'-y','LineWidth',2);
semilogy(X,sorted_dgbZPX2_1(X,6),'-','Color',[0,0.5,1],'LineWidth',2);
semilogy(X,sorted_PSICOV_1(X,6),'--k','LineWidth',2);
semilogy(X,sorted_SCA_1(X,6),'--','Color','y','LineWidth',2);
semilogy(X,sorted_OMES_1(X,6),'--','Color','g','LineWidth',2);
semilogy(X,sorted_McBASC_1(X,6),'--','Color','m','LineWidth',2);
semilogy(X,sorted_ELSC_1(X,6),'--','Color',[0,0.5,1],'LineWidth',2);
semilogy(X,sorted_fodorSCA_1(X,6),'--','Color','c','LineWidth',2);
hold off
...
X = (1:ncov);
semilogy(X,sorted_MI_2(X,6),'-r','LineWidth',2);
semilogy(X,sorted_logR_2(X,6),'-','Color',[0.3,0.6,0.2],'LineWidth',2);
% semilogy(X,MIP_2(X,6),'-','Color',[0.3,0.6,0.2],'LineWidth',2);
semilogy(X,sorted_ZPX2_2(X,6),'-m','LineWidth',2);
semilogy(X,sorted_DCA_2(X,6),'-g','LineWidth',2);
semilogy(X,sorted_nbZPX2_2(X,6),'-c','LineWidth',2);
semilogy(X,sorted_dbZPX2_2(X,6),'-y','LineWidth',2);
semilogy(X,sorted_dgbZPX2_2(X,6),'-','Color',[0,0.5,1],'LineWidth',2);
semilogy(X,sorted_PSICOV_2(X,6),'--k','LineWidth',2);
semilogy(X,sorted_SCA_2(X,6),'--','Color','y','LineWidth',2);
semilogy(X,sorted_OMES_2(X,6),'--','Color','g','LineWidth',2);
semilogy(X,sorted_McBASC_2(X,6),'--','Color','m','LineWidth',2);
semilogy(X,sorted_ELSC_2(X,6),'--','Color',[0,0.5,1],'LineWidth',2);
semilogy(X,sorted_fodorSCA_2(X,6),'--','Color','c','LineWidth',2);
hold off
