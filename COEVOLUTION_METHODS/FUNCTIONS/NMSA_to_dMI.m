function [ MI_mat ] = NMSA_to_dMI( nmsa )
...
% ngc = no gap correction. It differs from NMSA_to_MI because it retains
% the values in the diagonal. Useful for spectral analysis.
