...
% calculate piecewise ('SAVE'). The option 'SAVE' is extremely useful for
% computers with limited amount of memory or for very long sequences:
% however, the calculation is significantly slower with this option.
...
%       NMSA_to_4D_ZPX2(nmsa,'GAPS','4D','FULL','SINGLE',0.9,1,21,0,0,3);
%
...
% [ZPX2,md3_ZPX2,md4_ZPX2] = ...
%       NMSA_to_4D_ZPX2(nmsa,'GAPS','4D','FULL','PARALLEL',0.9,1,22,0,1,3);
%
%--------------------------------------------------------------------------
