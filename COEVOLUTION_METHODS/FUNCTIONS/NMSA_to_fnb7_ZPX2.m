function [ZPX2,ZPX2_orig,MI,sW,gW,gW1,gW2] = ...
    NMSA_to_fnb_ZPX2(nmsa,dist_method,threshold,psc_lambda,gW_e1,gW_e2,gW_e3)
...
% 'gW_e2' is the exponent of the weights for this round.
%
% Recommended syntax:
%
...
% [nbZPX2] = NMSA_to_fnb_ZPX2(nmsa,'GAPS',0.9,1,2,0,3);
%
...
% [nbZPX2] = NMSA_to_fnb_ZPX2(nmsa,'GAPS',0.9,1,0,0,3);
% or:
% [nbZPX2] = NMSA_to_fnb_ZPX2(nmsa,'GAPS',0.9,1,0,1,3);
