function [ MI_mat ] = NMSA_to_gcMI_2( nmsa )
...
% Dwinnel package. It differs from NMSA_to_gcMI because, although it 
% disregards the rows with gaps it does not corrects further for the 
% presence of gaps by introducing a weighing matrix.
