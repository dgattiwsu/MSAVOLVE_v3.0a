function [ZPX2,MIP,MI] = NMSA_to_nb3_ZPX2(nmsa)
% This function differs from nbZPX2 only because we do not set the diagonal
% of the nbMI matrix equal to NaN. The difference is minimal.
